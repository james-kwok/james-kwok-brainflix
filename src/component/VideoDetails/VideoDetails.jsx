...
const VideoDetails = ({displayVideo}) => {
    ...
    const videoTimestamp = new Date(displayVideo.timestamp).toLocaleDateString("en-US", {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
    });
    ...
    return (
        ...
        <div className = "VideoDetails__container">
            ...
            <p className = "VideoDetails__comments">{displayVideo.comments.length} Comments</p>
        </div>
    )
}
